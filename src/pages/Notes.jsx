  ...
  const handleFileUpload = async (e) => {
    ...
    if (newWindow) {
      newWindow.document.write(
        "<html><body><p style='font-family:sans-serif;'>Uploading your file... This window will show your file when ready.</p></body></html>",
      );
    }
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    toast({
                      title: "Delete failed",
                      description: err.message ?? "Could not delete folder",
                      variant: "destructive",
                    });
                  }
                }}
          ...
          <Card className="border-dashed">
            <CardContent className="flex flex-col items-center gap-3 py-16">
              ...
              <p className="text-sm text-muted-foreground">
                {search ? "No files match your search" : "No notes yet"}
              </p>
              {!search && (
                <Button
                  size="sm"
