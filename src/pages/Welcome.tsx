...
const features = [
  { icon: BookOpen, label: "Smart Schedules", desc: "Organize your study time effortlessly" },
  { icon: Clock, label: "Focus Timer", desc: "Stay on track with timed sessions" },
  { icon: Trophy, label: "Earn Rewards", desc: "Collect gems and unlock achievements" },
  { icon: Brain, label: "AI Assistant", desc: "Get instant help with your doubts" },
];
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-between bg-background px-6 py-12 safe-top safe-bottom">
      ...
      <div className="flex flex-1 flex-col items-center justify-center text-center">
        ...
        <h1 className="mb-2 text-4xl font-bold tracking-tight text-foreground">TimeTable</h1>
        <p className="mb-10 max-w-xs text-muted-foreground">
          Your smart study companion — build habits, stay focused, and ace your goals.
        </p>
