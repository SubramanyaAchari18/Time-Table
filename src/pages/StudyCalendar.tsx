    ...
    <div className="flex flex-col gap-5 px-5 pb-24 pt-6 safe-top">
      ...
      <Card>
        <CardContent className="p-4 text-xs text-muted-foreground">
          {loading ? "Loading events..." : "Tap any day to add exams, assignments or study reminders."}
        </CardContent>
      </Card>

      <AddEventModal open={modalOpen} onOpenChange={setModalOpen} date={selectedDate} eventToEdit={editingEvent ?? undefined} />
    </div>
  );
};
