...
import type { CalendarEventType, CalendarEvent } from "@/firebase/calendarService";
...
export const AddEventModal = ({ open, onOpenChange, date, eventToEdit }: AddEventModalProps) => {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-3">
          ...
          <Button className="rounded-xl w-full" onClick={handleSave} disabled={isSaving}>
            {isSaving ? "Saving..." : eventToEdit ? "Save changes" : "Add event"}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
