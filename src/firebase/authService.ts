 ...
 */
export async function startPhoneSignIn(phoneNumberE164: string, recaptchaContainerId: string): Promise<ConfirmationResult> {
...
export async function confirmPhoneOtp(confirmation: ConfirmationResult, otpCode: string) {
